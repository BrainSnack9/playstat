      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button asChild variant="outline" size="sm">
            <Link href={`/baseball/daily/${new Date().toISOString().split('T')[0]}`}>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        <Card className="p-6">
          ...
          <Button asChild variant="outline" size="sm" className="w-full">
            <Link href="/baseball/matches">{common('view_matches')}</Link>
          </Button>
        </Card>
        ...
        <Card className="p-6">
          ...
          <Button asChild variant="outline" size="sm" className="w-full">
            <Link href="/baseball/teams">{common('view_teams')}</Link>
          </Button>
        </Card>
        ...
        <Card className="p-6">
          ...
          <Button asChild variant="outline" size="sm" className="w-full">
            <Link href="/baseball/leagues">{common('view_leagues')}</Link>
          </Button>
        </Card>
      </section>
    </div>
